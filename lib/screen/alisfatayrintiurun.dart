...
class Alisfatayrintiurun extends StatefulWidget {
  final int dt;
  Alisfatayrintiurun(this.dt);
  @override
  _AlisfatayrintiurunState createState() => _AlisfatayrintiurunState();
}

class _AlisfatayrintiurunState extends State<Alisfatayrintiurun> {
  ...
  void initState() {
    ...
    Future.wait([
      APIServices.alfatdetayal(widget.dt),
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Text(
                        "Kalan    ${Load.numfor.format(fat.geneltoplam.round() - fat.odendimik.round())}TL",
                        style: TextStyle(
                            fontSize: 18,
                            color: Colors.grey,
                            fontWeight: FontWeight.bold)),
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              (fat.geneltoplam - fat.odendimik) == 0
                                  ? Icon(Icons.verified,
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                  text:
                                                      "${Load.numfor.format(fat.geneltoplam.round())} ",
                                                  style: TextStyle(
                                                      color: Colors.blue,
                                                      fontSize: 18)
                                                  //       fontWeight:
                                        ...
                                        child: RichText(
                                          text: TextSpan(
                                            ...
                                            children: <TextSpan>[
                                              TextSpan(
                                                  text:
                                                      " ${Load.numfor.format(fat.geneltoplam.round() - fat.odendimik.round())}",
                                                  style: TextStyle(
                                                      color: Colors.blue,
                                                      fontSize: 18)
                                                  //       fontWeight:
