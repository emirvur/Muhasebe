                    ...
                    return Container(
                      ...
                      child: ListTile(
                        onTap: () async {
                          ...
                          liscar = [];
                          lisirs = await APIServices.getcariris(cari.cariId);
                          setState(() {
                            arama = false;
                          });
                        },
                      ...
                      child: FlatButton(
                        ...
                        onPressed: () async {
                          ...
                          try {
                            ...
                            List<int> w = await APIServices.irsifatyap(
                              cari.cariId,
                            );
                            //     print(g.toString());
                            //       await APIServices.urharfatidekle(g,);

                            for (int i = 0; i < lisirs.length; i++) {
                              contara = contara + lisirs[i].aratop;
                              contgen = contgen + lisirs[i].geneltop;
                            }
                            Get.find<Satisfatcontroller>().eklesatfat(
                                Dtofattahs(
                                    w[0],
                                    1,
                                    0,
