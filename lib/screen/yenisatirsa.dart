...
class Yenisatirsa extends StatefulWidget {
  @override
  _YenisatirsaState createState() => _YenisatirsaState();
}

class _YenisatirsaState extends State<Yenisatirsa> {
