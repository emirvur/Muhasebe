                                                                ...
                                                                try {
                                                                  ...
                                                                  Get.find<Alisfatcontroller>().alisffattumekleyeni(Dtofatode(
                                                                      ...
                                                                      odendimi ==
                                                                          ...
                                                                          : 0,
                                                                      h[1]));
                                                                  Get.find<Tedarliscontroller>().tedarbakguncel(
                                                                      cari
                                                                          .cariId,
                                                                      odendimi ==
                                                                              true
                                                                  ...
                                                                  odendimi ==
                                                                      ...
                                                                      ? Get.find<KasaController>().guncelle(
                                                                          ...
                                                                          aratop +
                                                                              topkdv)
                                                                      : topkdv =
                                                                          topkdv; //   Dtofattahs fat=Dtofattahs(fatid, fatTur, durum, cariId, cariad, duztarih, fataciklama, katad, aratop, araind, kdv, geneltoplam, vadta, alta, alinmism, tahsid)
                                                                  Get.find<
