...
class Yenited extends StatefulWidget {
  @override
  _YenitedState createState() => _YenitedState();
}

class _YenitedState extends State<Yenited> {
    ...
    return SafeArea(
      child: Scaffold(
          /*     appBar: AppBar(
              ...
              title: Wdgappbar(" Tedarikçiler >", "Yeni", "Ahmet Seç")),
          drawer: Theme(
