...
class Mustodeekle extends StatefulWidget {
  final int dt;
  final String cari;
  Mustodeekle(this.dt, this.cari);
  @override
  _MustodeekleState createState() => _MustodeekleState();
}

class _MustodeekleState extends State<Mustodeekle>
