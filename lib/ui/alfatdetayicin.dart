...
class Alfatdetailicinurun extends StatefulWidget {
  final int dt;
  Alfatdetailicinurun(this.dt);
  @override
  _AlfatdetailicinurunState createState() => _AlfatdetailicinurunState();
}

class _AlfatdetailicinurunState extends State<Alfatdetailicinurun> {
  ...
  void initState() {
    ...
    APIServices.alfatdetayal(widget.dt).then((value) {
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    ...
                    child: Text("Kalan    ${fat.geneltoplam - fat.odendimik}TL",
                        style: TextStyle(
                            fontSize: 18,
                            color: Colors.grey,
                            fontWeight: FontWeight.bold)),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Align(
                                      alignment: Alignment.centerRight,
                                      child: Text(
                                          "Müşteriden Tahsilat   ${ltah[index].odendimik} TL",
                                          style: TextStyle(
                                              fontSize: 18,
                                              color: Colors.grey,
                                              fontWeight: FontWeight.bold)),
